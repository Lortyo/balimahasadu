...
export default function HomePage() {
  return (
    ...
    <div className={`flex-1 flex flex-col w-full ${inter.variable} ${playfair.variable} font-sans`}>
      ...
      ========================================= */}
      <section className="min-h-[calc(100vh-96px)] flex items-center w-full">
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          {/* Kolom Kanan: Gambar */}
          <div className="flex justify-center items-center md:p-1 lg:p-1">
            <img 
              src="/logo.png" 
              alt="Bali Mahasadu Logo" 
              className="w-full max-w-[280px] md:max-w-[340px] lg:max-w-[394px] h-auto object-contain drop-shadow-md"
            />
          </div>
      ...
      {/* =========================================
          ...
          Dibiarkan mengalir natural dengan py-24 agar tidak sesak
      ========================================= */}
        ...
        <div className="max-w-6xl mx-auto flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
            ...
            <div className="flex flex-col rounded-2xl overflow-hidden border border-gray-200/80 bg-[#FAFAF7]">
              {/* Image Placeholder (Ganti src ini dengan gambarmu nanti) */}
              <div className="h-64 w-full bg-[#C4C4C4]"></div>
              {/* Text Body */}
              <div className="p-8 flex flex-col flex-1">
                <h3 className="font-playfair text-2xl font-bold text-[#1c3832] mb-3">
                  Herbal Incense
                </h3>
                <p className="text-gray-500 leading-relaxed text-[15px]">
                  Aromatic incense made from natural Balinese herbs to create a calming atmosphere and enhance your relaxation experience.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col rounded-2xl overflow-hidden border border-gray-200/80 bg-[#FAFAF7]">
              ...
              <div className="p-8 flex flex-col flex-1">
                ...
                <p className="text-gray-500 leading-relaxed text-[15px]">
                  Premium oils formulated with traditional ingredients to nourish your skin and ease muscle tension during therapy.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col rounded-2xl overflow-hidden border border-gray-200/80 bg-[#FAFAF7]">
              ...
              <div className="p-8 flex flex-col flex-1">
                ...
                <p className="text-gray-500 leading-relaxed text-[15px]">
                  100% pure red ginger powder for a natural health boost, perfect for warming the body and improving circulation.
                </p>
              </div>
            </div>
          ...
          <div className="mt-14">
            <a 
              href="/products" 
              className="inline-flex items-center gap-2 px-8 py-3.5 bg-[#355E4E] text-white font-medium rounded-xl text-base hover:bg-[#2A4D40] transition-colors group"
            >
      ...
      <section className="w-full py-20 lg:py-24 px-4 bg-gradient-to-br from-[#30584b] to-[#4d7b6a]">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
            ...
            <a 
              href="/products" 
              className="w-full sm:w-auto px-8 py-3.5 border border-white text-white font-medium rounded-xl text-base hover:bg-white hover:text-[#30584b] transition-all duration-300"
            >
              Browse Products
            </a>
            ...
            <a 
              href="/contact" 
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-[#F8F9F6] text-[#30584b] font-medium rounded-xl text-base hover:bg-white transition-all duration-300 group"
            >
              Get in Touch 
              <span className="transition-transform group-hover:translate-x-1">&rarr;</span>
            </a>
